...
from environment import GateEnvironment, WORK_MIN, WORK_MAX, ARENA_SIZE, GATE_SIZE, MAX_GATES
...
def main():
    ...
    task = Task.init(project_name="DroneTrack", task_name=f"RL v3 All-at-Once - {env_name}")
    task.connect({
